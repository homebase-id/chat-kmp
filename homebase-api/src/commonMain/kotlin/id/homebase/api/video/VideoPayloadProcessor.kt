        ...
        val (compressedPath, compressElapsed) =
            measureTimedValue {
                compressor.compress(
                    ...
                    // Null here means ONLY "skipped — source positively probed 8-bit SDR and
                    // within the envelope", so falling back to the untranscoded source keeps
                    // the 8-bit guarantee. A failed transcode throws instead (see
                    // VideoCompressionFailedException) and fails the send.
                ) ?: payload.filePath
            }
