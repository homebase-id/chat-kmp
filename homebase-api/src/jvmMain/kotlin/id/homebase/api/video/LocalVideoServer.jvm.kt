 ...
 */
public actual class LocalVideoServer {
            ...
            routing {
                ...
                get("/content/{id}") {
                    ...
                    if (rangeHeader != null && rangeHeader.startsWith("bytes=")) {
                        ...
                        Logger.d("LocalVideoServer") { "Range request for $id: bytes=$start-$actualEnd/$totalSize (${contentType})" }
                        ...
                        Logger.d("LocalVideoServer") { "Serving full content: $id (${data.size} bytes, ${contentType})" }
