...
enum class NotificationContentLevel(val code: String, val displayName: String) {
    NAME_CONTENT_ACTIONS("name_content_actions", "Name, Content, and Actions"),
    NAME_ONLY("name_only", "Name Only"),
    NO_NAME_OR_CONTENT("no_name_or_content", "No Name or Content");
...
data class NotificationSettingsUiState(
    ...
    val notificationContentLevel: NotificationContentLevel =
        NotificationContentLevel.NAME_CONTENT_ACTIONS,
