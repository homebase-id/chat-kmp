...
data class MessageUiModel(
    ...
    val originalAuthorId: OdinId?, // TODO: Not sure we even (should) use this (it's chat)
    val senderOdinId: OdinId, // The message author, e.g. frodo.baggins.demo.rocks, can't be null
