...
import id.homebase.core.emoji.filterEmojis
import id.homebase.core.emoji.groupEmojis
...
fun EmojiSelection(
    ...
    emojiData?.let { emojiData ->
        val groupedEmojis = remember { groupEmojis(emojiData.emojis, emojiData.groups) }
        ...
        val filteredEmojis = remember(searchQuery, selectedSection) {
            if (isSearching) {
                ...
                filterEmojis(searchQuery, emojiData.emojis)
            } else {
